...
>(({ iconClassName, className, children, ...props }, ref) => (
...
const SelectItem = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof SelectPrimitive.Item> & { indicatorClassName?: string }
>(({ indicatorClassName, className, children, ...props }, ref) => (
