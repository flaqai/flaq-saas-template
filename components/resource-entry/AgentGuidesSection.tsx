...
const AGENT_GUIDES: AgentGuideItem[] = [
  ...
  {
    key: 'workbuddy',
    href: '/workbuddy-guide',
    image: 'https://cdn.flaq.ai/flaq/home_page/agent_guides/workbuddy_guide.webp?v=20260920',
    wide: true,
  },
];
      ...
      <div className='grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-12'>
        {AGENT_GUIDES.map((guide) => (
          <a
            ...
            className={cn('group block h-full', guide.wide ? 'lg:col-span-4' : 'lg:col-span-3')}
          >
            <article
              className={cn(
            ...
            >
              ...
              <div className={cn('flex min-w-0 items-start gap-2.5 lg:self-start', guide.wide ? 'order-first pb-3' : 'pt-3')}>
                ...
                <div className='min-w-0 flex-1'>
                  ...
                  <p className={cn('text-color-t3 mt-1 text-xs leading-[18px]', guide.wide ? 'line-clamp-1' : 'line-clamp-2')}>
